...
/*
    TFile *f1 = new TFile("Jpsi_pPb_RD_MuTrgNew2etabin1Rfb_1st_CBGpExp_Eff_test.root", "READ");
    TFile *f2 = new TFile("Jpsi_pPb_MC_MuTrgNew2etabin1Rfb_1st_CBGpExp_Eff_test.root", "READ");
*/

    TFile *f1 = new TFile("Jpsi_pPb_RD_MuTrgNew2etabin1CS_1st_CBGpExp_Eff_test.root", "READ");
    TFile *f2 = new TFile("Jpsi_pPb_MC_MuTrgNew2etabin1CS_1st_CBGpExp_Eff_test.root", "READ");

/*
    TFile *f1 = new TFile("Jpsi_pPb_RD_MuTrgNew2etabin1CS_1st_CBGpExp_Eff_Mu3_for_B_test.root", "READ");
    TFile *f2 = new TFile("Jpsi_pPb_MC_MuTrgNew2etabin1CS_1st_CBGpExp_Eff_Mu3_for_B_test.root", "READ");
*/
...
/*
    c1->SaveAs("Jpsi_TrgNew2etabin1Rfb_1st_Comp_pPb_MC_pt_L1_test.png");
    c1->SaveAs("Jpsi_TrgNew2etabin1Rfb_1st_Comp_pPb_MC_pt_L1_test.pdf");
*/
  
    c1->SaveAs("Jpsi_TrgNew2etabin1CS_1st_Comp_pPb_MC_pt_L1_test.png");
    c1->SaveAs("Jpsi_TrgNew2etabin1CS_1st_Comp_pPb_MC_pt_L1_test.pdf");

/*
    c1->SaveAs("Jpsi_TrgNew2etabin1CS_1st_Comp_pPb_MC_pt_Mu3_for_B_test.png");
    c1->SaveAs("Jpsi_TrgNew2etabin1CS_1st_Comp_pPb_MC_pt_Mu3_for_B_test.pdf");
*/
}
