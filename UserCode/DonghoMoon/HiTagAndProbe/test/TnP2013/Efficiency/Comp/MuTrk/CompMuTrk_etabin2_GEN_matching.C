...
void CompMuTrk_etabin_1st()
{
    ...
    TFile *f1 = new TFile("Jpsi_pPb_RD_MuTrketabin1_CBpPoly_1st_Run_Eff_test.root", "READ");
    TFile *f2 = new TFile("Jpsi_pPb_MC_MuTrketabin1_CBpPoly_1st_Run_Eff_test.root", "READ");

/*
    TFile *f1 = new TFile("Jpsi_pPb_RD_MuTrketabin1_CBpPoly_1st_Run_Eff_for_B_test.root", "READ");
    TFile *f2 = new TFile("Jpsi_pPb_MC_MuTrketabin1_CBpPoly_1st_Run_Eff_for_B_test.root", "READ");
*/
...
//    lt1->DrawLatex(0.50,0.7,"CMS Preliminary");
    ...
    c1->SaveAs("Jpsi_MuTrketabin1_G2pP4_p1_Comp_pPb_pt_test.png");
    c1->SaveAs("Jpsi_MuTrketabin1_G2pP4_p1_Comp_pPb_pt_test.pdf");

/*
    c1->SaveAs("Jpsi_MuTrketabin1_G2pP4_p1_Comp_pPb_pt_for_B_test.png");
    c1->SaveAs("Jpsi_MuTrketabin1_G2pP4_p1_Comp_pPb_pt_for_B_test.pdf");
*/
}
