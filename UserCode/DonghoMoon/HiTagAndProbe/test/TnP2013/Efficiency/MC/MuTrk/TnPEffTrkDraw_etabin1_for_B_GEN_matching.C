...
void TnPEffTrkDraw_etabin1_1st_for_B ();
...
char *outfile_ = "Jpsi_pPb_RD_MuTrketabin1_CBpPoly_1st_Run_Eff_for_B_test.root";
//char *outfile_ = "Jpsi_pPb_MC_MuTrketabin1_CBpPoly_1st_Run_Eff_for_B_test.root";
...
void TnPEffTrkDraw_etabin1_1st_for_B () {
    ...
    char *files[maxFile_] = {
        "tnp_pPb_Ana_MuTrketabin1_2GpP4_1st_Run_All_for_B_test.root",
//        "tnp_pPb_Ana_MuTrketabin1_2GpP4_MC_All_for_B_test.root",
    };
    ...
    for(int l = 0; l < maxFile_; l++){
        ...
        RooDataSet *daTrkEta1bin = (RooDataSet*)f->Get("MuonTrketabin1/isTrk_1bin_pt_eta/fit_eff");
        ...
        RooDataSet *daTrkPt = (RooDataSet*)f->Get("MuonTrketabin1/isTrk_pt/fit_eff");
        ...
        */
        ...
        if(MC_){
            pic_name_png = "Jpsi_pPb_MC_Trketabin1_" + middle_name + "_pt_for_B_test.png";
            pic_name_pdf = "Jpsi_pPb_MC_Trketabin1_" + middle_name + "_pt_for_B_test.pdf";
        }else{
            pic_name_png = "Jpsi_pPb_RD_Trketabin1_1st_run_" + middle_name + "_pt_for_B_test.png";
            pic_name_pdf = "Jpsi_pPb_RD_Trketabin1_1st_run_" + middle_name + "_pt_for_B_test.pdf";
        }
    ...
    for(int i = 0; i < maxFile_; i++){
        ...
        RooDataSet *dataTrkPt = (RooDataSet*)finput.Get("MuonTrketabin1/isTrk_pt/fit_eff");
...
/*
        c2->SaveAs("Jpsi_pPb_RD_Trketabin1_1st_run_CNT_test.png");
        c2->SaveAs("Jpsi_pPb_RD_Trketabin1_1st_run_CNT_test.pdf");
*/
/*
...
/*
            c2->SaveAs("Jpsi_pPb_RD_Trketabin1_1st_run_pt_CNT_test.png");
            c2->SaveAs("Jpsi_pPb_RD_Trketabin1_1st_run_pt_CNT_test.pdf");
*/
/*
