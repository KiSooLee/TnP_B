...
TString outfile_ = "Jpsi_pPb_MC_MuTrketabin1_2GpP4_Eff_Mass_Plots_total_for_B_no_matching_test.ps";
...
void TnPDrawMass_etabin1_1st_for_B() {
    ...
    char *infile;
    char *files[maxfile_] = {
        "../../Ana/MC/MuTrk/tnp_pPb_Ana_MuTrketabin1_2GpP4_MC_for_B_no_matching_test.root",
    };
