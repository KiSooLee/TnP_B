...
void TnPEffTrgDraw_etabin1_1st_for_B();
...
char *outfile_ = "Jpsi_pPb_RD_MuTrgNew2etabin1CS_1st_CBGpExp_Eff_for_B_test.root"; // L1 or L2
//char *outfile_ = "Jpsi_pPb_MC_MuTrgNew2etabin1CS_1st_CBGpExp_Eff_for_B_test.root"; // L1 or L2
...
//        "tnp_pPb_Ana_MuTrgNew2etabin1CS_CBGpExp_MC_All_for_B_test.root",
    ...
    for(int l = 0; l < maxFile_; l++){
        ...
        daTrgEta1bin = (RooDataSet*)f->Get("MuonTrgNew2etabin1CS/PAMu3_1bin_pt_eta/fit_eff");
        ...
        RooDataSet *daTrgPt;
        if(TrgMode_ == 1) daTrgPt = (RooDataSet*)f->Get("MuonTrgNew2etabin1CS/PAMu3_pt/fit_eff");
        ...
        */
        ...
        if(MC_){
            pic_name_png = "Jpsi_pPb_MC_Trg_New2_etabin1CS_Mu3_" + middle_name + "_pt_for_B_test.png";
            pic_name_pdf = "Jpsi_pPb_MC_Trg_New2_etabin1CS_Mu3_" + middle_name + "_pt_for_B_test.pdf";
        }else{
            pic_name_png = "Jpsi_pPb_RD_Trg_New2_etabin1CS_1st_Mu3_" + middle_name + "_pt_for_B_test.png";
            pic_name_pdf = "Jpsi_pPb_RD_Trg_New2_etabin1CS_1st_Mu3_" + middle_name + "_pt_for_B_test.pdf";
        }
