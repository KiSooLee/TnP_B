...
TString outfile_ = "Jpsi_pPb_RD_MuTrgNew2CS_CBGpExp_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_RD_MuTrk2_2GpP4_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_RD_MuIdNew2CS_CBpPoly_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_MC_MuTrgNew2CS_CBGpExp_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_MC_MuTrk2_2GpP4_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_MC_MuIdNew2CS_CBpPoly_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
...
//        "tnp_pPb_Ana_MuIdNew2CS_CBpPoly_MC_All_for_B_test.root",
    };
    ...
    for(int l = 0; l < maxfile_; l++){
        ...
        TString etabins[etaBins] = {"eta_bin0_", "eta_bin1_", "eta_bin2_", "eta_bin3_"};
