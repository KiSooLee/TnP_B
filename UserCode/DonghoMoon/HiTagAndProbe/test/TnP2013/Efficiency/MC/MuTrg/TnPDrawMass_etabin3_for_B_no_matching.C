...
void TnPDrawMass_etabin3_1st_for_B();
...
TString outfile_ = "Jpsi_pPb_RD_MuTrgNew2etabin3CS_CBGpExp_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_RD_MuTrk2etabin3CS_2GpP4_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_RD_MuIdNew2etabin3CS_CBpPoly_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_MC_MuTrgNew2etabin3CS_CBGpExp_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_MC_MuTrk2etabin3CS_2GpP4_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
//TString outfile_ = "Jpsi_pPb_MC_MuIdNew2etabin3CS_CBpPoly_1st_Run_Eff_Mass_Plots_total_for_B_test.ps";
...
//        "tnp_pPb_Ana_MuTrk2etabin3_2GpP4_1st_Run_All_for_B_test.root",
//        "tnp_pPb_Ana_MuIdNew2etabin3CS_CBpPoly_1st_Run_All_for_B_test.root",
//        "tnp_pPb_Ana_MuTrgNew2etabin3CS_CBGpExp_MC_All_for_B_test.root",
//        "tnp_pPb_Ana_MuTrk2etabin3_2GpP4_MC_All_for_B_test.root",
//        "tnp_pPb_Ana_MuIdNew2etabin3CS_CBpPoly_MC_All_for_B_test.root",
    };
    ...
    for(int l = 0; l < maxfile_; l++){
        ...
        if(Mode_ == 1) {
            if(TrgBit_ == 1){
                dir_pt = "MuonTrgNew2etabin3CS/PAMu3_pt/";
                intg = "MuonTrgNew2etabin3CS/PAMu3_1bin_pt_eta/eta_bin0__pt_bin0_";
            ...
            dir_pt = "MuonTrketabin3/isTrk_pt/";
            intg = "MuonTrketabin3/isTrk_1bin_pt_eta/eta_bin0__eta_bin0_";
            dir_suffix = "_twoGaussPlusPoly4";
        }else if (Mode_ == 3){
            dir_pt = "MuonIDNew2etabin3CS/PassingTrk_pt/";
            intg = "/MuonIDNew2etabin3CS/PassingTrk_1bin_eta_pt/eta_bin0__pt_bin0_";
