...
TString outfile_ = "Jpsi_pPb_MC_MuIdNew2etabin3CS_CBpPoly_Eff_Mass_Plots_total_for_B_GEN_matching_test.ps";
...
void TnPDrawMass_etabin3_1st_for_B() {
    ...
    char *infile;
    char *files[maxfile_] = {
        "../../Ana/MC/MuId/tnp_pPb_Ana_MuIdNew2etabin3CS_CBpPoly_MC_for_B_GEN_matching_test.root",
    };
    ...
    for(int l = 0; l < maxfile_; l++){
        ...
        if(Mode_ == 1) {
            ...
            intg = "/MuonIDNew2etabin3CS/PassingTrk_1bin_pt_eta/eta_bin0__pt_bin0_";
