...
void TnPEffMuIdDraw_etabin3_1st_for_B();
...
char *outfile_ = "Jpsi_pPb_RD_MuIdNew2etabin3CS_CBpPoly_1st_Run_Eff_for_B_test.root";
//char *outfile_ = "Jpsi_pPb_MC_MuIdNew2etabin3CS_CBpPoly_1st_Run_Eff_for_B_test.root";
...
//        "tnp_pPb_Ana_MuIdNew2etabin3CS_CBpPoly_MC_All_for_B_test.root",
    ...
    for(int l = 0; l < maxFile_; l++){
        ...
        RooDataSet *daMuIdEta1bin = (RooDataSet*)f->Get("MuonIDNew2etabin3CS/PassingTrk_1bin_eta_pt/fit_eff");
        ...
        RooDataSet *daMuIdPt = (RooDataSet*)f->Get("MuonIDNew2etabin3CS/PassingTrk_pt/fit_eff");
        ...
        */
        ...
        if(MC_){
            pic_name_png = "Jpsi_pPb_MC_MuIdNew2etabin3CS_" + middle_name + "_pt_for_B_test.png";
            pic_name_pdf = "Jpsi_pPb_MC_MuIdNew2etabin3CS_" + middle_name + "_pt_for_B_test.pdf";
        }else{
            pic_name_png = "Jpsi_pPb_RD_MuIdNew2etabin3CS_1st_run_" + middle_name + "_pt_for_B_test.png";
            pic_name_pdf = "Jpsi_pPb_RD_MuIdNew2etabin3CS_1st_run_" + middle_name + "_pt_for_B_test.pdf";
        }
