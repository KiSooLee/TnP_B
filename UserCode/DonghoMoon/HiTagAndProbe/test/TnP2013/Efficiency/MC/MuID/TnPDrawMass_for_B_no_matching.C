...
TString outfile_ = "Jpsi_pPb_RD_MuIdNew2CS_CBpPoly_MC_Eff_Mass_Plots_total_for_B_no_matching_test.ps";
...
void TnPDrawMass_for_B() {
    ...
    char *infile;
    char *files[maxfile_] = {
        "../../Ana/MC/MuId/tnp_pPb_Ana_MuIdNew2CS_CBpPoly_MC_for_B_no_matching_test.root",
    };
