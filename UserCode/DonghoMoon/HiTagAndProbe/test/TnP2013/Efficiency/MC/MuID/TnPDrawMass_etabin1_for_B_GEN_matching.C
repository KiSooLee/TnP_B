...
int Mode_ = 3; // 1 - Trg, 2 - Trk, 3 - MuId
const int maxfile_ = 1; 
const int ptBins = 7;
TString Cat1 = "MC"; // MC or RD
TString Cat2 = "MuId"; // Trg, Trk or MuId 
TString Cat3 = "Muon Id"; // Trigger, Inner Tracker or Muon Id
...
TString outfile_ = "Jpsi_pPb_MC_MuIdNew2etabin1CS_CBpPoly_Eff_Mass_Plots_total_for_B_GEN_matching_test.ps";
...
void TnPDrawMass_etabin1_1st_for_B() {
    ...
    char *infile;
    char *files[maxfile_] = {
        "../../Ana/MC/MuId/tnp_pPb_Ana_MuIdNew2etabin1CS_CBpPoly_MC_for_B_GEN_matching_test.root",
    };
    ...
    for(int l = 0; l < maxfile_; l++){
        ...
        if(Mode_ == 1) {
            ...
            intg = "/MuonIDNew2etabin1CS/PassingTrk_1bin_pt_eta/eta_bin0__pt_bin0_";
