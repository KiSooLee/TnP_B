...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("/afs/cern.ch/user/k/kilee/public/TnP_B/UserCode/DonghoMoon/HiTagAndProbe/test/TnP2013/Ana/MC/MuID/tnp_pA_MC_Prod_Merge_for_B_no_matching_20140730.root"),
    InputDirectoryName = cms.string("MuonIDNew2CS"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_pPb_Ana_MuIdNew2CS_CBpPoly_MC_for_B_no_matching_test.root"),
